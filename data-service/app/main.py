"""
Data Service - Main Application Entry Point.
...
app = FastAPI(
    title="QuantBull Data Service",
    version=settings.service_version,
    description="Data collection and management service for QuantBull platform",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def root() -> Dict[str, str]:
    ...
    return {
        "service": settings.service_name,
        "version": settings.service_version,
        "description": "Data collection and management service",
        "docs": "/docs",
        "status": "/status",
    }
