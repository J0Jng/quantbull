"""
Base cleaner class for quantitative data processing.
"""
...
class BaseCleaner(ABC):
    """
    Abstract base class for all data cleaners in quant engine.
    
    All cleaners should inherit from this class and implement
    the required methods for cleaning quantitative data.
    """
